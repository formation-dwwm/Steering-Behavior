...
class Seek implements ISeeker, Phaser {
...
class ApproachingSeekerSimple extends Seek {
    ...
    getDesiredVelocity(pTarget, pVehicle2bis) {
        this.vecDesired = new Phaser.Point.subtract(pTarget.position, pVehicle2bis.position);
        return vecDesired;
    }
